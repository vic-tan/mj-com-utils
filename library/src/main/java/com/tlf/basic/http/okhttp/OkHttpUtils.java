...
import com.tlf.basic.http.okhttp.builder.HeadBuilder;
import com.tlf.basic.http.okhttp.builder.OtherRequestBuilder;
import com.tlf.basic.http.okhttp.builder.PostFileBuilder;
import com.tlf.basic.http.okhttp.builder.PostFormBuilder;
import com.tlf.basic.http.okhttp.builder.PostStringBuilder;
import com.tlf.basic.http.okhttp.callback.Callback;
import com.tlf.basic.http.okhttp.cookie.SimpleCookieJar;
import com.tlf.basic.http.okhttp.https.HttpsUtils;
import com.tlf.basic.http.okhttp.log.LoggerInterceptor;
...
public class OkHttpUtils
{
    ...
    public void execute(final RequestCall requestCall, Callback callback)
    {
        ...
        requestCall.getCall().enqueue(new cn.bmob.v3.okhttp3.Callback()
        {
            @Override
